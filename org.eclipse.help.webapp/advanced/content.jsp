...
<script>
	...
	<frame ACCESSKEY="K" name="ContentViewFrame" title="main content" src='<%=UrlUtil.htmlEncode(data.getContentURL())%>'  marginwidth="10"<%=(data.isIE() && "6.0".compareTo(data.getIEVersion()) <=0)?"scrolling=\"yes\"":""%> marginheight="0" frameborder="0"
           onload="changeRootHREF();changeRootTitle();return true;">
	<%
